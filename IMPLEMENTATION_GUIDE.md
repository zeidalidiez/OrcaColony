# OrcaColony implementation and systems proof guide

This document preserves the detailed development commands, measured systems
proofs, and historical implementation narrative. For the shorter project entry
point, see [README.md](README.md).
...
It covered only `0.111` packed-data epochs. The exposure-only continuation is
now fixed in
